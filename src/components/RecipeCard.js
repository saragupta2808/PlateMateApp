  ...
  const nutritionalValuepopover = (
    <Popover id="popover-basic">
      <Popover.Header as="h3">
        {Math.round(props.calories * 100) / 100} kcal per serving
      </Popover.Header>
    ...
    <>
      ...
      >
        <button
          ...
          style={{ position: "absolute", bottom: "55px", left: "72px" }}
        >
          {" "}
      ...
      <Card.Body>
        <Card.Text>
          ...
          <span onClick={props.handleFavs}>
            <FontAwesomeIcon
              icon={props.isFavorite ? faHeartCircleCheck : faHeartRegular}
              size="2xl"
              style={{
                color: "rgb(171 40 31)",
                position: "absolute",
