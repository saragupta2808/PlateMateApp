      ...
      return (
        <p className="ingredient-item" key={index}>
          <input
            ...
            name="list-item"
            className="check-box"
            checked={ingredient.isStriked}
            onChange={() => props.handleStrike(index, ingredient)}
          />

          <label className="ingredient-label" htmlFor="list-item">
            {ingredient.isStriked ? (
              <p className="final" style={{ color: "#422800" }}>
                <s>{ingredient.ingredient_line} </s>
              </p>
            ) : (
              <p className="final" style={{ color: "#422800" }}>
      ...
      <>
        <div>
          <div style={{ display: "flex", alignItems: "center" }}>
            ...
            />
            <h6
              style={{ color: "#0c7b68", marginLeft: "5px", marginBottom: "0" }}
            >
              {foodName}
            </h6>
  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Footer>
          <button className="button-74" onClick={props.handleCloseList}>
            Close
          </button>
        </Modal.Footer>
      </Modal>
